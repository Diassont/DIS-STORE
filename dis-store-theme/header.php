...
<header class="site-header">
  <div class="header-shell">
    ...
    <div class="header-actions-outside">
      ...
      <!-- Обране -->
      <a class="header-action-link header-action-icon has-tooltip"
         data-tooltip="Обране"
      ...
      <a class="header-action-link header-action-icon has-tooltip"
         ...
         href="<?php echo esc_url(home_url('/compare/')); ?>">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <!-- Увійти / Ім'я -->
      <a class="header-action-link header-action-text" href="<?php echo esc_url($account_url); ?>">
  ...
  <div class="mobile-menu" id="mobileMenu" hidden>
    <div class="container mobile-menu-inner">
      ...
      <div class="mobile-header-actions">
        ...
        <a class="header-action-link header-action-icon" href="<?php echo esc_url(home_url('/wishlist/')); ?>" aria-label="Обране">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
          </svg>
        </a>

        <a class="header-action-link header-action-icon" href="<?php echo esc_url(home_url('/compare/')); ?>" aria-label="Порівняння">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <line x1="18" y1="20" x2="18" y2="10"/>
            <line x1="12" y1="20" x2="12" y2="4"/>
            <line x1="6" y1="20" x2="6" y2="14"/>
        ...
        <a class="header-action-link header-action-icon cart-icon-wrap" href="<?php echo esc_url($cart_url); ?>" aria-label="Кошик">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/>
            <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/>
          </svg>
